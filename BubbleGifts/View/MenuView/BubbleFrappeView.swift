...
final class BubbleFrappeView: UIView {
    
    private let scrollView: UIScrollView = {
        let scrollView = UIScrollView()
        scrollView.backgroundColor = .white
        scrollView.contentSize = CGSize(width: UIScreen.main.bounds.width, height: UIScreen.main.bounds.height * 954/852)
        scrollView.contentInsetAdjustmentBehavior = .never
        return scrollView
    }()
    
    public let contentView = UIImageView(image: UIImage(named: "bubbleFrappe"))
    ...
    private func setupConstraints() {
        ...
        contentView.snp.makeConstraints { make in
            ...
            make.height.equalTo(UIScreen.main.bounds.height * 954/852)
        }
