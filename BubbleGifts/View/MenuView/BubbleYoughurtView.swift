...
final class BubbleYoughurtView: UIView {
    
    private let contentView = UIImageView(image: UIImage(named: "bubbleYoghurt"))
...
extension BubbleYoughurtView {
    ...
    public func setupButtons(sv: DrinkButtons) {
        ...
        sv.yoghurtButton.setImage(UIImage(named: "fullDrink"), for: .normal)
